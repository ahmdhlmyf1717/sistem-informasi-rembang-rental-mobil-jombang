      ...
      <div class="col-lg-4 mb-5">
        <div class="card">
          ...
          <div class="card-footer border-top-0 bg-transparent">
            <div class="text-center">
              <a class="btn d-flex align-items-center justify-content-center btn-primary mt-auto" href="https://api.whatsapp.com/send?phone=6281358015210&text=Saya%20tertarik%20menyewa%20mobil%20{{ $car->nama_mobil }} ini%20segera." style="column-gap: 0.4rem">Sewa Mobil <i class="ri-whatsapp-line"></i></a>
            </div>
          </div>
        </div>
      </div>
